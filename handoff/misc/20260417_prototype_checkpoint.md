...
> ⚠️ **注意（2026-04-23 追記）**: このファイルはプロトタイプ期の記録です。
> 「handoff/ は .gitignore する」「フォルダ名は `ai-team-yourname/`」など、
> **現行方針と矛盾する設計判断が含まれています**。
> 現行の運用方針は [docs/knowledge.md](../../docs/knowledge.md) と
> [CLAUDE.md](../../CLAUDE.md) を参照してください。
> 履歴として残していますが、ここの記述に従って動作しないでください。
